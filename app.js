...
function applyStaticText(){
  ...
  const searchLabel=text(
    setting("Search Button Label","Search menu")
  );
...
function applySettings(settings){
  ...
  const reserveText=text(setting("Reserve Button Text","RESERVE A TABLE"));
  ...
  groups.forEach(
    (group,groupIndex)=>{
      ...
      group.items.forEach(item=>{
        ...
        const soldOutPriceText=text(
          setting("Sold Out Price Text","—")
        );
        ...
        if(item.featured){
          ...
          const featuredText=text(
            setting("Featured Badge Text","GYLT SELECT")
          );
